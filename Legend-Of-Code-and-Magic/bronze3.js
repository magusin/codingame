...
const costRanges = {
    ...
    un: { min: 1, max: 1, desiredPercentage: 0.133, currentCount: 0 },
    deux: { min: 2, max: 2, desiredPercentage: 0.166, currentCount: 0 },
    trois: { min: 3, max: 3, desiredPercentage: 0.134, currentCount: 0 },
    quatre: { min: 4, max: 4, desiredPercentage: 0.134, currentCount: 0 },
    cinq: { min: 5, max: 5, desiredPercentage: 0.134, currentCount: 0 },
    six: { min: 6, max: 6, desiredPercentage: 0.1, currentCount: 0 },
    high: { min: 7, max: 12, desiredPercentage: 0.066, currentCount: 0 },
